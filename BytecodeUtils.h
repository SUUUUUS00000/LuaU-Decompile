...
inline int getOpLength(LuauOpcode op) {
    ...
    case LOP_NEWTABLE: case LOP_SETLIST: case LOP_FORGLOOP:
    case LOP_LOADKX: case LOP_FASTCALL2: case LOP_FASTCALL2K:
    case LOP_FASTCALL3: case LOP_JUMPXEQKNIL: case LOP_JUMPXEQKB:
    case LOP_JUMPXEQKN: case LOP_JUMPXEQKS:
    case LOP_GETUDATAKS: case LOP_SETUDATAKS: case LOP_NAMECALLUDATA:
        return 2;
    default: return 1;
    }
}
...
inline bool isFastCall(LuauOpcode op) {
    ...
    case LOP_FASTCALL2K: case LOP_FASTCALL3:
        return true;
...
inline bool isJumpD(LuauOpcode op) {
    switch (op) {
    case LOP_JUMP: case LOP_JUMPIF: case LOP_JUMPIFNOT:
    case LOP_JUMPIFEQ: case LOP_JUMPIFLE: case LOP_JUMPIFLT:
    case LOP_JUMPIFNOTEQ: case LOP_JUMPIFNOTLE: case LOP_JUMPIFNOTLT:
    case LOP_FORNPREP: case LOP_FORNLOOP: case LOP_FORGPREP:
    case LOP_FORGLOOP: case LOP_FORGPREP_INEXT: case LOP_FORGPREP_NEXT:
    case LOP_JUMPBACK: case LOP_JUMPXEQKNIL: case LOP_JUMPXEQKB:
    case LOP_JUMPXEQKN: case LOP_JUMPXEQKS:
        return true;
    default: return false;
    }
...
inline bool isFallthrough(LuauOpcode op) {
    switch (op) {
    case LOP_RETURN: case LOP_JUMP: case LOP_JUMPBACK: case LOP_JUMPX:
        return false;
    default: return true;
    }
}
